...
public:
	...
	static WFFileIOTask *create_pread_task(const std::string& filename,
										   void *buf,
										   size_t count,
										   off_t offset,
										   fio_callback_t callback);
	...
	static WFFileIOTask *create_pwrite_task(const std::string& filename,
											const void *buf,
											size_t count,
											off_t offset,
											fio_callback_t callback);
	...
	static WFFileVIOTask *create_preadv_task(const std::string& filename,
											 const struct iovec *iov,
											 int iovcnt,
											 off_t offset,
											 fvio_callback_t callback);
	...
	static WFFileVIOTask *create_pwritev_task(const std::string& filename,
											  const struct iovec *iov,
											  int iovcnt,
											  off_t offset,
											  fvio_callback_t callback);
	...
	static WFFileSyncTask *create_fsync_task(const std::string& filename,
											 fsync_callback_t callback);
	...
	static WFFileSyncTask *create_fdsync_task(const std::string& filename,
											  fsync_callback_t callback);
